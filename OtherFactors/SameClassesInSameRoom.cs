...
{
    class SameClassesInSameRoom : IFactor
    {
        int fine;
        bool isBlock;
        ...
        public int GetFineOfAddedClass(ISchedule schedule, EntityStorage eStorage)
        {
            ...
            {
                if (ClassesTime.CheckClassesHasSameRoom(schedule, classRow, sClasses))
                {
                    if (isBlock)
        ...
        public int GetFineOfFullSchedule(ISchedule schedule, EntityStorage eStorage)
        {
            ...
            {
                if (ClassesTime.CheckClassesHasSameRoom(schedule, classIndex, sClasses))
                {
                    if (isBlock)
                        return Constants.BLOCK_FINE;
                    else
        ...
        {
            return "Одинаковые пары лучше ставить в одну и ту же аудитория";
        }
        public string GetName()
        {
            return "Пары в одной аудитории";
        }
